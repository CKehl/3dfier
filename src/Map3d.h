...
private:
  ...
  void stitch_bridges(TopoFeature* f1, int ringi1, int pi1, TopoFeature* f2, int ringi2, int pi2);
  void stitch_bridges(TopoFeature* f1, int ringi1, int pi1, TopoFeature* f2, int ringi2, int pi2, int refz);
